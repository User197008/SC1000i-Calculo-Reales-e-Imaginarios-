 ...
 */
public class M_iReturn {
    public static String M_i (String cadena) {  
            ...
            if(!"i".equals(NumIma.get(2)) && !"i".equals(NumIma.get(4)) && !"i".equals(NumIma.get(5)))  {   
                ...
                if("i".equals(NumIma.get(2)) && "i".equals(NumIma.get(5)))  {   
                    if("-".equals(NumIma.get(0)))   {   
                        ...
                        elementos.add(ind+3, String.valueOf(Float.parseFloat(NumIma.get(1)) * Float.parseFloat(NumIma.get(4))*-1));
                        elementos.remove(ind+2);
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                        ...
                        elementos.add(ind+3, String.valueOf(Float.parseFloat(NumIma.get(4))*-1));
                        elementos.remove(ind+2);
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                        ...
                        elementos.add(ind+3,"+");
                        elementos.add(ind+4,NumIma.get(4));
                        elementos.remove(ind+2);
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                    ...
                    if("-".equals(NumIma.get(0)))   {   
                        ...
                        elementos.add(ind+2, String.valueOf(Float.parseFloat(NumIma.get(1))*-1));
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                        elementos.remove(ind-2); 
                    ...
                    if("-".equals(NumIma.get(0)))   {   
                        ...
                        elementos.add(ind+2,"-");
                        elementos.add(ind+3,NumIma.get(3));
                        elementos.add(ind+4,"i");
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                        ...
                        elementos.add(ind+2,NumIma.get(4));
                        elementos.add(ind+3,"i");
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                    ...
                    if("-".equals(NumIma.get(1)))   {   
                        ...
                        elementos.add(ind+2,NumIma.get(2));
                        elementos.add(ind+3,"i");
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
