 ...
 * @author jaime
 */
public class DIV1Return {
    public static String DIV1 (String cadena) {  
        ...
        while (count > 0)   {
            ...
            if(")".equals(cadenaLista.get(INDEX-1)))    {   // ) /   
                if("(".equals(cadenaLista.get(INDEX+1))) {   // ) / (
                    int inicio;
                    if(INDEX-6 != 0)    {   // ufhdd67 + ( 2 + 3 i ) / (
                         
                        if(!"(".equals(cadenaLista.get(INDEX-7)))    {   // ghru67 + ( 2 + 3 i ) * (
                    ...
                    String nuevo = D3Return.D3(viejo);
                    ...
                    if(INDEX-6 != 0)    {  
                        ...
                        int subinicio = Collections.max(po)-1;
                    ...
                    String nuevo2 = D2Return.D2(viejo2);
                ...
                if("(".equals(cadenaLista.get(INDEX+1)))    {   
                    ...
                    String Nuevo3 = D1Return.D1(viejo3);
                ...
                {  // - 2 / 3 i
                    ...
                    String nuevo5 = D_iReturn.D_i(viejo5);
                ...
                { 
                   ...
                   int inicio = 0;
                    ...
                    String nuevo6 = D_iReturn.D_i(viejo6);
                    
                    cadena = cad1 + nuevo6 + cad2 ;
