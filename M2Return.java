 ...
 * @author jaime
 */
public class M2Return {
    public static  String M2 (String cadena) {  
        ...
        if("i".equals(NuCom.get(10)))    {
            if("+".equals(NuCom.get(3)))    {  
                if("+".equals(NuCom.get(0)))    {   
                    elementos.add(ind+4,"-");
                    elementos.add(ind+5,String.valueOf(Float.parseFloat(NuCom.get(2)) * Float.parseFloat(NuCom.get(9))));
                    elementos.add(ind+6, "i");
                    elementos.add(ind+7, "+");
                    elementos.add(ind+8,String.valueOf(Float.parseFloat(NuCom.get(4)) * Float.parseFloat(NuCom.get(9))));
                    ...
                    elementos.add(ind+4,String.valueOf(Float.parseFloat(NuCom.get(2)) * Float.parseFloat(NuCom.get(9))*-1));
                    elementos.add(ind+5, "i");
                    elementos.add(ind+6, "+");
                    elementos.add(ind+7,String.valueOf(Float.parseFloat(NuCom.get(4)) * Float.parseFloat(NuCom.get(9))));
                    elementos.remove(ind+3);
                    elementos.remove(ind+2);
                    elementos.remove(ind+1);
                    elementos.remove(ind);
            ...
            if("+".equals(NuCom.get(3)))    {   
                if(!"-".equals(NuCom.get(8)) && !"+".equals(NuCom.get(8)))  {
                    if("+".equals(NuCom.get(0)))     {  
                        elementos.add(ind+3,"+");
                        elementos.add(ind+4,String.valueOf(Float.parseFloat(NuCom.get(2)) * Float.parseFloat(NuCom.get(8))));
                        elementos.add(ind+5, "i");
                        elementos.add(ind+6, "-");
                        elementos.add(ind+7,String.valueOf(Float.parseFloat(NuCom.get(4)) * Float.parseFloat(NuCom.get(8))));
                        elementos.remove(ind+2);
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                        ...
                        elementos.add(ind+5, "-");
                        elementos.add(ind+6,String.valueOf(Float.parseFloat(NuCom.get(4)) * Float.parseFloat(NuCom.get(8))));
                        elementos.remove(ind+2);
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                    ...
                    if("+".equals(NuCom.get(0)))    {   
                        ...
                        elementos.add(ind+6,"i");
                        elementos.add(ind+7,"+");
                        elementos.add(ind+8,String.valueOf(Float.parseFloat(NuCom.get(4))));
                        elementos.remove(ind+2);
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                        ...
                        elementos.add(ind+3,String.valueOf(Float.parseFloat(NuCom.get(2))*-1));
                        elementos.add(ind+4,"i");
                        elementos.add(ind+5,"+");
                        elementos.add(ind+6,String.valueOf(Float.parseFloat(NuCom.get(4))));
                        elementos.remove(ind+2);
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
                ...
                if(!"-".equals(NuCom.get(8)) && !"+".equals(NuCom.get(8)))  {   
                    ...
                    if("+".equals(NuCom.get(0)))    {   
                        ...
                        elementos.add(ind+5, "i");
                        elementos.add(ind+6, "-");
                        elementos.add(ind+7,String.valueOf(Float.parseFloat(NuCom.get(4))));
                        elementos.remove(ind+2);
                        elementos.remove(ind+1);
                        elementos.remove(ind);
                        elementos.remove(ind-1);
            ...
            if("+".equals(NuCom.get(3)))    {   
                if("+".equals(NuCom.get(0)))    {   
                    elementos.add(ind+2,"+");
                    elementos.add(ind+3,String.valueOf(Float.parseFloat(NuCom.get(2))));
                    elementos.add(ind+4, "i");
                    elementos.add(ind+5, "-");
                    elementos.add(ind+6,String.valueOf(Float.parseFloat(NuCom.get(4))));
                    elementos.remove(ind+1);
                    ...
                    elementos.add(ind+2,String.valueOf(Float.parseFloat(NuCom.get(2))));
                    elementos.add(ind+3, "i");
                    elementos.add(ind+4, "-");
                    elementos.add(ind+5,String.valueOf(Float.parseFloat(NuCom.get(4))));
                    elementos.remove(ind+1);
                    elementos.remove(ind);
                    elementos.remove(ind-1);
                    elementos.remove(ind-2);
            ...
            if("+".equals(NuCom.get(3)))    {   
                ...
                else if("(".equals(NuCom.get(0)))    {   // ( ( 3 - 4 i ) * 2
                    elementos.add(ind+2,String.valueOf(Float.parseFloat(NuCom.get(2)) * Float.parseFloat(NuCom.get(8))));
                    elementos.add(ind+3, "-");
                    elementos.add(ind+4,String.valueOf(Float.parseFloat(NuCom.get(4)) * Float.parseFloat(NuCom.get(8))));
                    elementos.add(ind+5,"i");
