...
public class MUL2Return {    
    public static String calcula(String cadena) {
        ...
        String var4 = MUL1Return.MUL1(var3);
    ...
    public static String MUL2 (String cadena) {          
               
        int count = MiniLibrary.countOccurrences(cadena, '*');
        
        String resultado;                                                           ////////////////////////////////////modi2
        while (count > 0)   {
            ...
            if(")".equals(cadenaLista.get(INDEX-1)))    {   
                if("(".equals(cadenaLista.get(INDEX+1))) {   
                    ...
                    String cadenaWW = "";                    
                    //String cadenafin = MiniLibrary.ListToString(cadenaLista.subList(fin2+INDEX+1, cadenaLista.size()));
                    if(MiniLibrary.split(subnuevo).size() > 3 && MiniLibrary.split(subnuevo2).size()<=3)  {
                        ...
                        if ("(".equals(SubcadenaObjB.get(0)) ){
                            ...
                            cadena = M2Return.M2(cadenaObj);                                                                       ///////////////////////modi2
                        ...
                        if("(".equals(SubcadenaObjA.get(0)) ){                   /////////////////modi2
                            ...
                            resultado = M1Return.M1(cadenaObj);                                                                       ///////////////////////modi2
                            ...
                            String ReMul = cadena1c + subnuevo + " " + cadena1d + " * " + cadena2 + subnuevo2 + cadena2a;        /////////////////////modi2
                            
                            
                            resultado = M3Return.M3(ReMul);                                                       /////////////////////////////////////modi2
                        ...
                        if(MiniLibrary.split(subnuevo).size() <= 3 && MiniLibrary.split(subnuevo2).size() <= 3){
                             ...
                             cadenaWW = cadenaWW.replace("(","");                         ////////////////////////////////////////////////////////////////////modi2
                             cadena = cadenaWW.replace(")","");                                 ////////////////////////////////////////////////////////////modi2
                            ...
                            cadena = cadena1a + cadena1b + "( " + M3Return.M3(cadenaWW) + " )" + cadena2b;
                    ...
                    if(MiniLibrary.split(subnuevo).size()<=3)   {
                        ...
                        String cadenaW = cad1 + subnuevo + cad2;           ///////////////////////////// modi2
                        
                        if(cadenaW.contains("*") ){                        ///////////////////////////  modi2
                            cadena = MUL1Return.MUL1(cadenaW);             ////////////////////////// modi2
                ...
                if("(".equals(cadenaLista.get(INDEX+1)) && "i".equals(cadenaLista.get(INDEX-1)))   {    
                    String subfinal;                                ///////modi1
                    String sub = null;                              //////modi1
                    int inicio = 0;
                    if(INDEX>3) {
                    ...
                    int ini2 = 0;
                    int ini = 0;                   
                    List<String> tr = cadenaLista3.subList(0,cadenaLista.size());        //////modi1
                    ArrayList<Integer> y1 = new ArrayList<>();
                    ArrayList<Integer> x1 = new ArrayList<>();                           ///////modi2
                    ...
                    while(it.hasNext()) {
                        ...
                        if(x.equals("(")) {
                            ...
                            if(xo==yo)  {
                                ...
                                Integer iniF = Collections.max(x1); //////modi2
                                
                                Integer finF = Collections.min(y1); ////// modi1
                    ...
                    if(subb == 1)   {
                        ...
                        if(!"(".equals(cadenaLista.get(INDEX+2)))  {                                                //modi1
                            ...
                            String nuevo3 = M1Return.M1(subfinal);
                            ...
                            if(visu2.size()>2){                                                     //////modi2
                                String caden1 = MiniLibrary.ListToString(cadenaLista.subList(0, INDEX-2));   
                            ...
                            //System.out.println("MUL2.cadena1f-1: " + cadena1);
                            String cadena2 = " " + MiniLibrary.ListToString(cadenaLista.subList(fin+1,cadenaLista.size())) + " "; /////////modi1
                            System.out.println("MUL2.cadena2f-1: " + cadena2);
                            cadena = cadena1 + nuevo3 + cadena2;
                            
                            
                        }
                        else    {                                                                               /////modi1
                            System.out.println("MUL2.cadenaLista: " + cadenaLista);                                 /////modi1
                            String cad1 = MiniLibrary.ListToString(cadenaLista.subList(inicio, ini)) + " ";     /////modi1
                            System.out.println("MUL2.cad1q2: " + cad1);                                             /////modi1
                            String cad2 = " " + MiniLibrary.ListToString(cadenaLista.subList(fin+1,cadenaLista.size()));          /////modi1
                            System.out.println("MUL2.cad2q2: " + cad2);
                            
                            if(MiniLibrary.split(subnuevo).size() > 0 && MiniLibrary.split(subnuevo).size() < 4){
                                subfinal = cad1 + " " + subnuevo + " " + cad2;                        /////modi1
                                System.out.println("MUL2.subfinal-2a: " + subfinal);
                            }else{
                                subfinal = cad1 + " " + "( " + subnuevo + " )" + " " + cad2;
                                System.out.println("MUL2.subfinal-2b: " + subfinal);
                            }/////modi1
                            //subfinal = cad1 + " " + subnuevo + " " + cad2;                        /////modi1
                            System.out.println("MUL2.subfinal-2: " + subfinal);                                     /////modi1
                            
                            String subfinal2 = rem.rem(subfinal);                            //// ///////modi2////////rem
                            System.out.println("MUL2.subfinal2: " + subfinal2);
                            String nuevo3 = M1Return.M1(subfinal2);
                            System.out.println("MUL2.nuevo3: " + nuevo3);
                            String cadena1 = MiniLibrary.ListToString(cadenaLista.subList(0, inicio)) + " ";
                            System.out.println("MUL2.cadena1f: " + cadena1);
                            String cadena2 = " " + MiniLibrary.ListToString(cadenaLista.subList(fin+1,cadenaLista.size() - 1)) + " "; /////////modi1
                            System.out.println("MUL2.cadena2f: " + cadena2);
                            //System.out.println("MUL2.cadenaLista: " + cadenaLista);
                            
                            //cadena = cadena1 + nuevo3 + cadena2;
                            cadena = nuevo3;
                            System.out.println("MUL2.cadenaf: " + cadena);
                            //final
                        ...
                        //System.out.println("MUL2.cadenaLista: " + cadenaLista);
                        //String cad1 = MiniLibrary.ListToString(cadenaLista.subList(inicio, INDEX+1)) + " ";
                        //System.out.println("MUL2.cad1q: " + cad1);
                        //String cad2 = " " + MiniLibrary.ListToString(cadenaLista.subList(fin,fin+1));
                        //System.out.println("MUL2.cad2q: " + cad2);
                        //String subfinal = cad1 + " " + "(" + " " + subnuevo + " " + ")";
                        //System.out.println("MUL2.subfinal: " + subfinal);
                        
                        //String nuevo3 = M1Return.M1(subfinal);
                        //System.out.println("MUL2.nuevo3: " + nuevo3);
                        //String cadena1 = MiniLibrary.ListToString(cadenaLista.subList(0, inicio)) + " ";
                        //System.out.println("MUL2.cadena1f: " + cadena1);
                        //String cadena2 = " " + MiniLibrary.ListToString(cadenaLista.subList(fin+1,cadenaLista.size())) + " ";
                        //System.out.println("MUL2.cadena2f: " + cadena2);
                        //cadena = cadena1 + nuevo3 + cadena2;
                        //System.out.println("MUL2.cadenaf: " + cadena);
                        //final
                    ...
                    else if("(".equals(cadenaLista.get(INDEX+1)) && !"i".equals(cadenaLista.get(INDEX-1))){   // -3 * (    +++++++++      ) + iiiiiiiiii
                    int inicio5 = 0;
                    int fin5 = 0;
                ...
                if(MiniLibrary.OccurrencesString(cadenaR,"*") > 0){
                    ...
                    if ("(".equals(cadenaLista.get(inicio))) {                                          
